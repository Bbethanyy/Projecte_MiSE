...
leds_RGB(uint8_t izq_led,uint8_t der_led){ //Modifica el color dels LEDS RGB
    ...
    Array_led[1]=izq_led; //El color del led esquerra
...
//
//    }
uint16_t movement_duration = 1000;

while (1) {
        // Procesa l'estat del joystick
        switch (joystick_state) {
            ...
            case 1: // TOP
                ...
                mov_motor(0x00, 0x00, 0x00, 0x00); // para el motor després de 1s
                joystick_state = 50;               // resetea l'estat del joystick
                break;
            ...
            case 2: // LEFT
                ...
                delay(movement_duration);
                mov_motor(0x00, 0x00, 0x00, 0x00); // para el motor després de 1s
                joystick_state = 50;               // Reset l'estat del joystick
                break;
            ...
            case 3: // BOTTOM
                ...
                move_cursor(0x00);
                delay(movement_duration);
                mov_motor(0x01, 0x20, 0x01, 0x20); // para el motor
                joystick_state = 50;               // Resetea l'estat del joystick
                break;
            ...
            case 4: // RIGHT
                ...
                move_cursor(0x00);
                delay(movement_duration);
                mov_motor(0x00, 0x00, 0x00, 0x00); // para el motor
                joystick_state = 50;               // resetea l'estat
                break;
...
__interrupt void port3_ISR(void)
{
    ...
    P3IE=0X00;                   //Deshabilitar interrupcions
    P3IES^=0X3E;                 //
    joystick_state=0x00;



    // Llegeix l'estat del joystick input
    switch (vector_flag) {
            case 0x00: break;
            case 0x02: break;
            ...
            case 0x04: // P3.1 BOTTOM
                if ((P3IN & BIT1) == 0) {
                    joystick_state = 3; // Possar l'estat per a bottom
                } else {
                    joystick_state = 0;
                }
                break;
            ...
            case 0x06: // P3.2 LEFT
                if ((P3IN & BIT2) == 0) {
                    joystick_state = 2; // estat per a LEFT
                } else {
                    joystick_state = 0;
                }
                break;
            ...
            case 0x08: // P3.3 TOP
                if ((P3IN & BIT3) == 0) {
                    joystick_state = 3; //Estat per a TOP
                } else {
                    joystick_state = 0;
                }
                break;
            ...
            case 0x0A: // P3.4 RIGHT
                if ((P3IN & BIT4) == 0) {
                    joystick_state = 4; // Estat per a RIGHT
                } else {
                    joystick_state = 0;
                }
                break;
            ...
            case 0x0C: // P3.5 BUTTON
                if ((P3IN & BIT5) == 0) {
                    joystick_state = 5; // Estat per a BUTTON
                } else {
                    joystick_state = 0;
                }
                break;
        ...
        P3IFG = 0x00; // Clear interrupt flag
        P3IE = 0x3E;  // Enable interrupts
    }
